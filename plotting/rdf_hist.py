...
def plot_single(root: Path, label: str, out_path: Path, exclude: Set[str]) -> None:
    fig, axes = plt.subplots(2, 1, figsize=(7, 8), sharex="col")
...
def main() -> None:
    ...
    ap.add_argument("--label", default="rdf_11_WAT_O", help="RDF stem (without .dat/.int.dat)")
    ap.add_argument("--out", default="reports/rdf_hist.png", type=Path, help="Output PNG path")
    ...
    plot_single(args.root, args.label, args.out, exclude)
