...
def main() -> None:
    ...
    ap.add_argument("--root", type=Path, required=True, help="Root containing run-*/equil/analysis files")
    ap.add_argument("--out", type=Path, default=Path("reports/rdf_bv_hydrogens.png"),
